...
func updateStatus(ctx context.Context, st composed.State) (error, context.Context) {
	...
	redisInstance := state.ObjAsManagedRedisInstance()
	hasChanged := false
	...
	// keys, err := state.client.GetRedisInstanceAccessKeys(ctx, resourceGroupName, state.ObjAsManagedRedisInstance().Name)
