...
func main2() {
	...
	ga, _ := compute.NewGlobalAddressesRESTClient(ctx, option.WithCredentialsFile("/Users/i517577/Documents/gcpcred/sap-sc-learn-redis-sa.json"))

	result, _ := ga.Get(ctx, &computepb.GetGlobalAddressRequest{
		Project: projectId,
		Address: "cm-d2421a1f-717c-4406-bdfa-3538310e08f1",
	})

	fmt.Printf(*result.Address)
